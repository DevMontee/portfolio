"""
TRACKING VISUALIZATION TO VIDEO
===============================

Save entire tracking sequence as MP4 video.

Run:
    python visualize_to_video.py

Output: tracking_output.mp4
"""
...
def run_video_export():
    """Export tracking visualization to video."""
    
    print("\n" + "="*80)
    print("TRACKING VISUALIZATION TO VIDEO".center(80))
    print("="*80 + "\n")
    ...
    print(f"\n\n{'='*80}")
    print("VIDEO EXPORT COMPLETE".center(80))
    print(f"{'='*80}\n")
